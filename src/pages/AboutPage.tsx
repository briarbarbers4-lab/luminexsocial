          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-soft-white/70 leading-relaxed">
                Founded in 2020, Luminex Social emerged from a simple vision: to help businesses shine brighter in the digital landscape. What started as a small team of passionate social media strategists has grown into a full-service digital agency serving brands across multiple industries.
              </p>
              <p className="text-lg text-soft-white/70 leading-relaxed">
                We believe that exceptional social media management is about more than just posting content. It's about understanding your brand's unique voice, connecting with your audience authentically, and driving measurable results that impact your bottom line.
              </p>
            </div>

            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-royal-blue/20 to-royal-blue/5 rounded-2xl blur-xl" />
              <div className="relative bg-gradient-to-br from-royal-blue/10 to-transparent border border-royal-blue/20 rounded-2xl p-8 backdrop-blur-md">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-soft-white/60 mt-1">To empower businesses with innovative social media strategies that drive growth and engagement</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-royal-blue/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div>
                      ...
                      <p className="text-soft-white/60 mt-1">To be the most trusted social media partner for ambitious brands worldwide</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-royal-blue/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
      ...
      <section className="py-20 border-t border-soft-white/10">
        <div className="container mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-soft-white/60">Exceptional talent dedicated to your success</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-royal-blue/5 to-transparent border border-royal-blue/20 rounded-xl p-6 text-center hover:border-royal-blue/40 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="text-center p-8 bg-gradient-to-br from-royal-blue/5 to-transparent border border-royal-blue/20 rounded-xl hover:border-royal-blue/40 transition-all duration-300"
              >
            ...
            {[
              {
                ...
                description: 'Every strategy is backed by comprehensive analytics and insights to ensure measurable results.',
              },
              {
                title: 'Creative Excellence',
                description: 'Our award-winning creative team produces content that stands out and drives engagement.',
              },
              {
                title: '24/7 Support',
                description: 'We\'re always available to support your brand\'s social media needs and growth.',
              },
              {
                title: 'Industry Expertise',
                description: 'With experience across multiple industries, we understand diverse market dynamics.',
              },
              {
                title: 'Transparent Reporting',
                description: 'Clear, detailed reports keep you informed of your social media performance at all times.',
              },
              {
                title: 'Customized Solutions',
                description: 'No two brands are the same. We create tailored strategies for your unique needs.',
              },
            ].map((reason, index) => (
              <div
                key={index}
                className="p-8 bg-gradient-to-br from-royal-blue/5 to-transparent border border-royal-blue/20 rounded-xl hover:border-royal-blue/40 hover:shadow-lg hover:shadow-royal-blue/10 transition-all duration-300"
              >
